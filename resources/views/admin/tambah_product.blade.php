    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                action="{{ route('admin.simpan.product') }}">
                @csrf
                <div class="wg-box">
                    <fieldset class="name">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Masukan Harga" name="harga" tabindex="0"
                            value="{{ old('harga') }}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Masukan Stoke" name="Stok" tabindex="0"
                            value="{{ old('Stoke') }}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style="display:none">
                                <img src="../../../makjuicipicip.com/images/upload/upload-1.png" class="effect8" alt="">
                            </div>
