        ...
        <div class="main-content-wrap">
            ...
            <div class="tf-section-2 mb-30">
                ...
                <div class="container-fluid flex-wrap-mobile">
                                    ...
                                    <div class="flex items-center gap14">
                                        <div class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="#F24405" stroke-width="2"
                            ...
                            <div class="wg-chart-default mb-20">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap14">
                                        <div class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="#F24405" stroke="#F24405" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wg-chart-default mb-20">
                                <div class="body-text mb-2 fw-bold fs-4 ">Cetak Laporan</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="mb-10 form-select form-select-lg fs-4" name="bulan" id="bulan"
                                                    required>
                                                    @php
                                                        $bulanIndo = [
                                                            1 => 'Januari',
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <select class=" mb-10 form-select form-select-lg fs-4" name="tahun" id="tahun"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-grid  mb-3">
                                                <button type="submit" class="btn btn-success fs-4  btn-block btn-lg"
                                                    data-mdb-ripple-color="#ffffff" style="background-color:"
                                                    onclick="exportPDF()"><svg
                                                ...
                                                {{-- <button type="button" class="btn btn-success  btn-floating  btn-lg"> <i
            ...
            {{-- <div class="flex gap20 flex-wrap-mobile">
                ...
                <div class="w-half">
                    ...
                    <div class="wg-chart-default mb-20">
                        <div class="body-text mb-2 fw-bold fs-4 ">Pilih Bulan Laporan</div>
                        <div class="mb-3">
                            <label for="bulan" class="form-label fs-5">Bulan</label>
