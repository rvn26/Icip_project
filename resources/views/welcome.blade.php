<x-font-layout>
  ...
  {{-- <section class="bg-cream w-screen h-screen  ">
    <div
      class="max-w-7xl h-screen mx-auto px-4 sm:px-6 lg:px-8 py-10  md:py-20 flex flex-col md:flex-row items-center gap-10">
      ...
      <div
        class="md:w-1/2 mt-10 h-full bg-gradient-to-b from-orange2 via-orange3 to-black p-5 rounded-3xl shadow-black shadow-lg">
        <img alt="A stylish young woman wearing trendy fashion clothes posing in urban environment"
          class="rounded-lg shadow-lg w-full object-cover" height="400"
          src="{{ asset('img/Cuplikan layar 2025-05-07 102756.png') }}" width="600" />
      </div>
    </div>
  </section> --}}
