    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="{{ route('kasir.tambahproduct') }}"><i
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="list-icon-function">
                                    ...
                                    <a href="{{ route('kasir.edit.product',['id'=>$barang->id]) }}">
                                        <div class="item edit">
                                            <i class="icon-edit-3"></i>
                                        </div>
                                    </a>
                                    <form action="{{ route('kasir.hapus.product', ['id'=>$barang->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
