                ...
                <div class="checkout-form">
                        ...
                        <section class="md:col-span-2 bg-white p-5 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input class="w-full border border-black rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange1" id="nomer" name="nomer" required="" type="tel" value="{{ old('nomer') }}"  />
                                ...
                                <div>
                                    ...
                                    <input
                                        class="w-full border border-black rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange1"
                                        id="provinsi" name="provinsi" required="" type="text" value="{{ old('provinsi') }}" />
                    ...
                    <div class="checkout__totals-wrapper ">
                        <div class="sticky-content">
                            ...
                            <div class="checkout__totals font-poppins">
                                <h3>Pesanan Kamu</h3>
                            ...
                            <div class="checkout__payment-methods">
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio"
                                        name="mode" id="mode2" checked value="transfer">
