        ...
        <div id="page" class="">
            ...
            <div class="layout-wrap">
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.dashboard')}}" id="site-logo-inner" class="w-[100px] h-auto">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.tambahproduct') }}" class="">
                            ...
                            <div class="header-left">
                                {{-- <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt=""
                                        src="{{ asset('images/logo/Logo_Icip.png') }}"
                                        data-light="{{ asset('images/logo/Logo_Icip.png') }}"
                                        data-dark="{{ asset('images/logo/Logo_Icip.png') }}" data-width="100px"
                                        data-height="auto" data-retina="{{ asset('images/logo/Logo_Icip.png') }}">
                                </a> --}}
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
    ...
    {{-- <div class="modal fade" id="filterModal" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('admin.laporanexel') }}" method="GET"
                class="modal-content shadow rounded-4 border-0">
                <div class="modal-header bg-light border-0">
                    <h5 class="modal-title fw-semibold" id="filterModalLabel">📊 Filter Laporan
                        Penjualan</h5>
                ...
                <div class="modal-body py-4">
                    <div class="mb-3">
                        ...
                        <select name="bulan" id="bulan" class="form-select rounded-3" required>
