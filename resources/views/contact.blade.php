        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden md:flex md:space-x-6">
            <div class="md:w-1/2 p-8">
                ...
                <form action="#" class="space-y-6" method="POST" novalidate="">
                    <div>
                        ...
                        <input
                            class="w-full rounded-md border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-sans"
                    ...
                    <div>
                        ...
                        <textarea
                            class="w-full rounded-md border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none font-sans"
            ...
            <div class="md:w-1/2 bg-cream p-8 flex flex-col justify-center space-y-6">
                ...
                <p class="text-gray-700">
                    ...
                    J997+MX2, Perum Jl. Wirasana Indah, RT.03/RW.06, Wirasana, Kec. Purbalingga, Kabupaten Purbalingga, Jawa Tengah 53318
                </p>
                <p class="text-gray-700">
                ...
                <div class="mt-6">
                    ...
                    {{-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4050.1384567105397!2d109.35498797510502!3d-7.310325292697553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6ff7adb6b26319%3A0x43eac90f819b30a5!2sPerumahan%20Subsidi%20Bale%20Lambur!5e1!3m2!1sid!2sid!4v1747155250658!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> --}}
                </div>
