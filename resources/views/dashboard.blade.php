<x-app-layout>
    ...
    {{-- <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="products">
        ...
        <article
          ...
          <div class="p-4 flex flex-col flex-grow">
            ...
            <div class="mt-4 flex items-center justify-between">
              ...
              <button
                class="bg-orange3 text-white px-4 py-2 rounded-md hover:bg-orange1 transition text-sm"
              >
                Add to Cart
              </button>
            </div>
        ...
        @endforeach --}}
          ...
          >
            <img
              alt="Classic black leather jacket on a mannequin with a white background"
              class="rounded-t-lg w-full object-cover aspect-square"
              height="400"
              src="https://storage.googleapis.com/a1aa/image/0a14c337-c397-4826-1906-14b1dffdb6f6.jpg"
              width="400"
            />
            <div class="p-4 flex flex-col flex-grow">
              <h3 class="text-lg font-semibold text-gray-900 mb-2">
